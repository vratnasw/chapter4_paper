...
\centering
	...
	\begin{table}[H]
		\caption{Case study summary\mgnote{See me.}} % title of Table
		\centering  % used for centering table
...
\begin{table}[H]
		\caption{\mgnote{make two collumns for $n$, one for guessed and one for inferred. These guess really are not being varied. Guesses should have more variation, like $n=2.5$ and $n=3.5$. Remember rock rheology studies suggest $n=3.5$ and your values are considerably smaller. Is this an artifact?}Sensitivity of initial guesses for Case 1} % title of Table
		\centering  % used for centering table
...
\includegraphics[height=45mm,width=68mm]{sumatra.pdf}%{mesh.pdf}
}
\hspace{0.1cm}\subfigure{
\includegraphics[height=45mm,width=45mm]{sumatra_zoom.pdf}%{mesh.pdf}
}
\hspace{0.2cm}\subfigure{
\includegraphics[height=55mm,width=58mm]{middle.pdf}%{mesh.pdf}
}
\hspace{0.2cm}\subfigure{
\includegraphics[height=55mm,width=58mm]{middle_zoom.pdf}%{mesh.pdf}
}
%\hspace{-0.2cm}\subfigure[]{
%\includegraphics[height=35mm,width=58mm]{um_chap4.pdf}%{mesh.pdf}
%}
